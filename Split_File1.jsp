    ...
    <body>
     ...
     if(request.getParameter("duplicate")!=null){
        ...
        <div class="main">
            ...
            <div class="header">
       <div class="logo">
                    <h1>Blockchain Based Medical Healthcare Security System</h1>
                </div>
                <div class="menu_nav">
                    <ul>
                            ...
                            <div  style="width:90%; height: auto; border: 0px solid #2B70C9; margin-left: auto; margin-right: auto">
                                ...
                                <form action="StoreContent" method="post" name="form1">
                                    <div class="blockOne">
                                        ...
                                        <textarea name="firstBlock" id="firstBlock" class="splittextarea"><%= fb.trim()%></textarea>
                                ...
                                <div class="blockOne">
                                    ...
                                    <div class="sec2"><span>
                                    <textarea name="middleBlock" id="middleBlock" class="splittextarea"><%= mb.trim()%></textarea>
                                ...
                                <div class="blockOne">
                                    ...
                                    <div class="sec2"><span>
                                    <textarea name="lastBlock" id="lastBlock" class="splittextarea"><%= lb.trim()%></textarea>
